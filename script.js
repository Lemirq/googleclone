...
// Location
fetch('https://ipgeolocation.abstractapi.com/v1/?api_key=f2f98f8a8d96407c8b5d200946ac6590')
	...
	.then(function (payload) {
		...
		place.innerHTML = getcity + ',\u00A0' + getregion + ',\u00A0' + getcountry + '\u00A0|\u00A0' + getip;
	});
...
function getMobileOperatingSystem() {
	...
	if (/android/i.test(userAgent)) {
		document.querySelector('#getapp').addEventListener('click', function () {
			window.open('https://play.google.com/store/apps/details?id=com.google.android.googlequicksearchbox&hl=en&gl=US', '_self');
		});
	}
